...
public class MyListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            FileUtils.copyFile(src, new File("/Users/thanos-imac/IdeaProjects/extentreportapp" + result.getMethod().getMethodName() + ".png"));
            String file = test.addScreenCapture("/Users/thanos-imac/IdeaProjects/extentreportapp" + result.getMethod().getMethodName() + ".png");
